...
class _NumberChangePageState extends State<NumberChangePage> {
            ...
            child: Column(children: [
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if (value.length != 10) {
                    return "New phone number should be exactly 10 characters long";
                  }
                  return null;
                },
                buildCounter: (BuildContext context,
  ...
  Future<void> _CreatePDF() async {
    ...
    page.graphics.drawString('Number Change Request', font3,
    ...
    page.graphics.drawString(
        'New Phone Number: ${NewPhoneNumberController.text}', font,
        bounds: Rect.fromLTWH(25, yPosition as double, 500, 20));
    yPosition += 25;
...
class SheetsColumn {
  ...
  static const String New_Phone_Number = 'NewPhoneNumber';
