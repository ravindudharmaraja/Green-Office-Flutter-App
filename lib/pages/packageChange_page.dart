...
class PackageChangePage extends StatefulWidget {
  const PackageChangePage({Key? key}) : super(key: key);

  @override
  State<PackageChangePage> createState() => _PackageChangePageState();
}

class _PackageChangePageState extends State<PackageChangePage> {
  int currentStep = 0;
  ...
  // @override
  // void dispose() {
  //   CSUOfficerNameController.dispose();
  //   CSUOfficerServiceNoController.dispose();
  //   super.dispose();
  // }
  ...
  Future<void> _CreatePDF() async {
    ...
    final increasedFont = PdfStandardFont(PdfFontFamily.helvetica, 20);
    ...
    page.graphics.drawLine(PdfPen(PdfColor(0, 0, 0)),
        Offset(25, yPosition as double), Offset(550, yPosition as double));
    yPosition += 25;

    page.graphics.drawString('Package Change Request', increasedFont,
    ...
    page.graphics.drawImage(
        signatureImage, Rect.fromLTWH(30, yPosition as double, 100, 50));
    yPosition += 50;
    ...
    String filename = '${accountNumberController.text}_packageChange.pdf';
