...
class _RelocationPageState extends State<RelocationPage> {
  ...
  TextEditingController ExsistingAddressController = TextEditingController();
                ...
                onStepContinue: () {
                  ...
                  if (isLastStep) {
                    final feedback = {
                      ...
                      SheetsColumn.Exsisting_Address:
                          ExsistingAddressController.text.trim(),
                      SheetsColumn.New_Address:
        ...
        Step(
          ...
          content: Form(
            ...
            child: Column(children: [
              ...
              TextFormField(
                maxLength: 30,
                controller: ExsistingAddressController,
                decoration: const InputDecoration(
                  labelText: "Exsisting Address",
                  filled: true,
                  fillColor: Color.fromARGB(147, 255, 255, 255),
                  border: OutlineInputBorder(),
                ),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return "Please enter exsisting address";
                  }
                  // if (value.length != 6) {
  ...
  Future<void> _CreatePDF() async {
    ...
    page.graphics.drawString('Relocation Request', font3,
    ...
    page.graphics.drawString(
        'Exsisting Address: ${ExsistingAddressController.text}', font,
        bounds: Rect.fromLTWH(25, yPosition as double, 500, 20));
    yPosition += 25;

    page.graphics.drawString('New Address: ${NewAddressController.text}', font,
        bounds: Rect.fromLTWH(25, yPosition as double, 500, 20));
    yPosition += 25;
  ...
  page.graphics.drawString('The PDF file was automatically generated via the Green Office mobile application, a digital solution that helps reduce paper consumption and facilitates data collection.', font2,
    ...
    String filename = '${accountNumberController.text}relocation.pdf';
  ...
  void _resetForm() {
    ...
    ExsistingAddressController.clear();
...
class SheetsColumn {
  ...
  static const String Exsisting_Address = 'ExsistingAddress';
  static const String New_Address = 'NewAddress';
